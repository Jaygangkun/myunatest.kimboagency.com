...
<?php
 ...
 $winterEnding = date("Y-m-d", strtotime($data3[0]['SeasonStartDate'] . '+ 120 days'));
?>

<pre>
    <?php var_dump($winterTwoMonths); ?>
</pre>

<pre>
    <?php var_dump($winterEnding); ?>
</pre>



<?php
$winter_start = 'https://myuna.perfectmind.com/api/2.0/B2C/Appointments?startDate=' . $winterStart . '&endDate=' . $winterTwoMonths . '&pageSize=1000';
...
foreach($final_winter as $arr){
    ...
    $finalArray[] = array_merge($arr,$data[$key]);
}?>
