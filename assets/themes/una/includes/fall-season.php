...
?>
       ...
       <?php  $fallStart = date("Y-m-d", strtotime($data3[0]['SeasonStartDate'])); ?>

<!-- Get all Spring Programs-->

<!-- first API Call for The first 2 Months of Spring Program-->
<?php
 $summerStart = date("Y-m-d", strtotime($data3[1]['SeasonStartDate'])) ;
 $summerTwoMonths = date("Y-m-d", strtotime($data3[1]['SeasonStartDate'] . '+ 60 days'));
 $summerEnding = date("Y-m-d", strtotime($data3[0]['SeasonStartDate'] . '- 1 day'));
?>



<?php
$summer_start = 'https://myuna.perfectmind.com/api/2.0/B2C/Appointments?startDate=' . $summerStart . '&endDate=' . $summerTwoMonths . '&pageSize=1000';
...
$summer_end = 'https://myuna.perfectmind.com/api/2.0/B2C/Appointments?startDate=' . $summerTwoMonths . '&endDate=' . $summerEnding . '&pageSize=1000';
