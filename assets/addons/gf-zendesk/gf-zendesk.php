<?php
/**
* Plugin Name: Gravity Forms Zendesk
...
self::$plugin->instance();
  ...
  */
  ...
  if($type == "admin"){
     if($ver<4.2){
  ?>
    <div class="error vx_notice notice" data-id="<?php echo $id ?>"><p style="display: table"><span style="display: table-cell; width: 98%"><span class="dashicons dashicons-megaphone"></span> <b><?php _e('Gravity Forms Zendesk Plugin','gravity-forms-zendesk-crm') ?>. </b><?php echo wp_kses_post($message);?> </span>
<span style="display: table-cell; padding-left: 10px; vertical-align: middle;"><a href="#" class="notice-dismiss" title="<?php _e('Dismiss Notice','gravity-forms-zendesk-crm') ?>">dismiss</a></span> </p></div>
  <?php
     }else{
  ?>
  <div class="error vx_notice notice is-dismissible" data-id="<?php echo $id ?>"><p><span class="dashicons dashicons-megaphone"></span> <b><?php _e('Gravity Forms Zendesk Plugin','gravity-forms-zendesk-crm') ?>. </b> <?php echo wp_kses_post($message);?> </p>
  </div>    
  <?php
     }
  }else{
...
/*  if(empty($field)){
  ...
  */
  ...
  printf('<input type="checkbox" name="'.$this->id.'_update" id="'.$this->id.'_update" value="1" /><label for="'.$this->id.'_update" title="%s">%s</label><br /><br />', __('Create or update this entry in Zendesk. The fields will be mapped according to the form feed settings.', 'gravity-forms-zendesk-crm'), __('Send to Zendesk', 'gravity-forms-zendesk-crm'));
  } else {
...
if(!current_user_can($this->id."_send_to_crm")){return; }
  ...
  */
  ...
  RGFormsModel::add_note($id, 0, __('Gravity Forms Zendesk Plugin','gravity-forms-zendesk-crm'), $note);
  }
...
do_action('plugin_status_'.$this->type,'activate');  
  ...
  */
  ...
  $crm_tooltips = array(
    'vx_feed_name' => '<h6>' . __('Feed Name', 'gravity-forms-zendesk-crm') . '</h6>' . __('Enter feed name of your choice.', 'gravity-forms-zendesk-crm'),
  'vx_sel_object' => '<h6>' .__('Zendesk Object', 'gravity-forms-zendesk-crm') . '</h6>' . __('Select the Object to Create when a Form is Submitted.', 'gravity-forms-zendesk-crm'),
   'vx_sel_account' => '<h6>' .__('Zendesk Account', 'gravity-forms-zendesk-crm') . '</h6>' . __('Select the Zendesk account you would like to export entries to.', 'gravity-forms-zendesk-crm'),
  'vx_sel_form' => '<h6>' . __('Gravity Form', 'gravity-forms-zendesk-crm') . '</h6>' . __('Select the Gravity Form you would like to integrate with Zendesk. Contacts generated by this form will be automatically added to your Zendesk account.', 'gravity-forms-zendesk-crm'),
  
  'vx_map_fields' => '<h6>' . __('Map Standard Fields', 'gravity-forms-zendesk-crm') . '</h6>' . __('Associate your Zendesk fields to the appropriate Gravity Form fields.', 'gravity-forms-zendesk-crm'),
  
  'vx_optin_condition' => '<h6>' . __('Opt-In Condition', 'gravity-forms-zendesk-crm') . '</h6>' . __('When the opt-in condition is enabled, form submissions will only be exported to Zendesk when the condition is met. When disabled all form submissions will be exported.', 'gravity-forms-zendesk-crm'),
  
  'vx_manual_export' => '<h6>' . __('Manual Export', 'gravity-forms-zendesk-crm') . '</h6>' . __('If you do not want all entries sent to Zendesk, but only specific, approved entries, check this box. To manually send an entry to Zendesk, go to Entries, choose the entry you would like to send to Zendesk, and then click the "Send to Zendesk" button.', 'gravity-forms-zendesk-crm'),
  
    'vx_entry_notes' => '<h6>' . __('Entry Notes', 'gravity-forms-zendesk-crm') . '</h6>' . __('Enable this option if you want to synchronize Gravity Forms entry notes to Zendesk Object notes. For example , when you add a note to a Gravity Forms entry, it will be added to the Zendesk Object selected in the feed.', 'gravity-forms-zendesk-crm'),
    
      'vx_primary_key' => '<h6>' . __('Primary Key', 'gravity-forms-zendesk-crm') . '</h6>' . __('Which field should be used to update existing objects?', 'gravity-forms-zendesk-crm'),
    

    'vx_source_check'=>'<h6>' . __('Enable Lead Source', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to assign a lead source to this object.','gravity-forms-zendesk-crm'),
        
'vx_sources'=>'<h6>' . __('Zendesk Lead Sources', 'gravity-forms-zendesk-crm') . '</h6>' .__('Get Lead Sources list from zendesk.','gravity-forms-zendesk-crm'),
'vx_source'=>'<h6>' . __('Select Lead Source', 'gravity-forms-zendesk-crm') . '</h6>' .__('Which Lead Source should be assigned to this object.','gravity-forms-zendesk-crm'),

    'vx_status_check'=>'<h6>' . __('Enable Lead Status', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to assign a lead status to this object.','gravity-forms-zendesk-crm'),    
'vx_status_list'=>'<h6>' . __('Zendesk Lead Status List', 'gravity-forms-zendesk-crm') . '</h6>' .__('Get Lead Status list from zendesk.','gravity-forms-zendesk-crm'),
'vx_status'=>'<h6>' . __('Select Ticket Status', 'gravity-forms-zendesk-crm') . '</h6>' .__('Which Status should be assigned to this object.','gravity-forms-zendesk-crm'),
'vx_priority'=>'<h6>' . __('Select Ticket Priority', 'gravity-forms-zendesk-crm') . '</h6>' .__('Which Priority should be assigned to this object.','gravity-forms-zendesk-crm'),
'vx_type'=>'<h6>' . __('Select Ticket Type', 'gravity-forms-zendesk-crm') . '</h6>' .__('What should be Ticket Type.','gravity-forms-zendesk-crm'),



   'vx_assign_person'=>'<h6>' . __('Zendesk Person', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to assign a person to this object.','gravity-forms-zendesk-crm'),
   
      'vx_assign_check'=>'<h6>' . __('Assign Person', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to assign a user to this conversation.','gravity-forms-zendesk-crm'),
   'vx_sel_person'=>'<h6>' . __('Select Person', 'gravity-forms-zendesk-crm') . '</h6>' .__('Person created by selected feed will be added to this feed Object.','gravity-forms-zendesk-crm'),
   
   
   'vx_owner_check'=>'<h6>' . __('Assign Owner', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to assign an owner to this object.','gravity-forms-zendesk-crm'),
   
   'vx_owners'=>'<h6>' . __('Zendesk Users', 'gravity-forms-zendesk-crm') . '</h6>' .__('Get Users list from Zendesk','gravity-forms-zendesk-crm'),
   
      'vx_sel_owner'=>'<h6>' . __('Select Owner', 'gravity-forms-zendesk-crm') . '</h6>' .__('Select a user as a owner of this object','gravity-forms-zendesk-crm'),
   
      'vx_box_check'=>'<h6>' . __('Add to mailbox', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to add conversation in a mailbox.','gravity-forms-zendesk-crm'),
   
   'vx_boxes'=>'<h6>' . __('Zendesk Mailboxes', 'gravity-forms-zendesk-crm') . '</h6>' .__('Get mailboxes from Zendesk','gravity-forms-zendesk-crm'),
   
      'vx_sel_box'=>'<h6>' . __('Select Mailbox', 'gravity-forms-zendesk-crm') . '</h6>' .__('Select a mailbox in which you want to add conversation.','gravity-forms-zendesk-crm'),
   
   
   
   'vx_order_notes'=>'<h6>' . __('Entry Notes', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to synchronize Entry notes to Zendesk Object notes. For example, when you add a note to a Entry, it will be added to the Zendesk Object selected in the feed.','gravity-forms-zendesk-crm'),
  

         'vx_entry_note'=>'<h6>' . __('Entry Note', 'gravity-forms-zendesk-crm') . '</h6>' .__('Check this option if you want to send more data as CRM entry note.', 'gravity-forms-zendesk-crm'),
   'vx_note_fields'=>'<h6>' . __('Note Fields', 'gravity-forms-zendesk-crm') . '</h6>' .__('Select fields which you want to send as a note', 'gravity-forms-zendesk-crm'),
   'vx_disable_note'=>'<h6>' . __('Note Fields', 'gravity-forms-zendesk-crm') . '</h6>' .__('Enable this option if you want to add note only for new CRM entry', 'gravity-forms-zendesk-crm')
...
//
  ...
  if(!$is_admin && $event == 'paid' && $this->post('manual_export',$data) != '2'){ // only process paid event, if set in feed
  continue;   
  } 
