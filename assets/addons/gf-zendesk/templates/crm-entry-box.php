...
<div class="postbox">
<h3 style="border-bottom: 1px solid #ddd;"><?php _e("Zendesk", 'gravity-forms-zendesk-crm') ?></h3>
<div class="inside">
...
echo '<p style="background: '.$bg.'; padding: 10px; color: #fff " class="vx_msg_div"><i class="fa '.$icon.'"></i> '.$msg.'</p>';
  ...
  ?>
  <p>
  <button class="button" type="submit" name="<?php echo $this->id ?>_send" value="yes" title="<?php _e("Send to Zendesk",'gravity-forms-zendesk-crm')?>"><?php _e("Send to Zendesk",'gravity-forms-zendesk-crm')?></button>
  <?php
      if($comments ){
  ?>
    <a class="button button-secondary" title="<?php _e('Go to Logs','gravity-forms-zendesk-crm') ?>" href="<?php echo $log_url ?>"><?php _e('Go to Logs','gravity-forms-zendesk-crm') ?></a>
  <?php
      }
  ?>
  </p>
