...
.vxcf_options_row .howto{
  ...
  <div class="vx_wrap"> <img alt="<?php _e("Zendesk Feeds", 'gravity-forms-zendesk-crm') ?>" title="<?php _e("Zendesk Feeds", 'gravity-forms-zendesk-crm') ?>" src="<?php echo $this->get_base_url()?>images/<?php echo $this->crm_name ?>-crm-logo.png?ver=1" style="float:left; margin:0px 7px 10px 0;" height="46" />
  <h2 style="margin-bottom: 12px"><?php _e("Zendesk Feeds", 'gravity-forms-zendesk-crm'); ?>
  <?php
      if($fid != $config['id']){
  ?>
  <a class="add-new-h2" href="<?php echo $new_feed_link?>"><?php _e("Add New", 'gravity-forms-zendesk-crm') ?></a>
  <?php
      }
      if(!empty($fid)){
  ?>
  <a class="add-new-h2" href="<?php echo $feeds_link?>"><?php _e("Back to Feeds", 'gravity-forms-zendesk-crm') ?></a>
  <?php
      }
  ?>
  </h2>
...
if(empty($feed_name)){
  ...
  <?php wp_nonce_field("vx_nonce") ?>
    <div class="vx_div">
      <div class="vx_head">
<div class="crm_head_div"> <?php _e('1. Enter Feed name',  'gravity-forms-zendesk-crm' ); ?></div>
...
<div class="crm_clear"></div> 
  ...
  <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_name" class="left_header"><?php _e("Feed Name", 'gravity-forms-zendesk-crm'); ?>
  ...
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"> <?php _e('2. Select Zendesk Account.', 'gravity-forms-zendesk-crm'); ?></div>
<div class="crm_btn_div" title="<?php _e('Expand / Collapse','gravity-forms-zendesk-crm') ?>"><i class="fa crm_toggle_btn vx_action_btn fa-minus"></i></div>
<div class="crm_clear"></div> 
  </div>
  ...
  <div class="vx_group">
    <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_account" class="left_header"><?php _e("Zendesk Account", 'gravity-forms-zendesk-crm'); ?>
  ...
  <div class="clear"></div>
    ...
    <div id="crm_ajax_div_object" style="display:none; text-align: center; line-height: 100px;"><i> <?php _e('Loading, Please Wait...','gravity-forms-zendesk-crm'); ?></i></div>
...
//post validation
 ...
 if($(".vx_required").length){
   ...
   var value=""; 
    ...
    attach_error.append('<div class="entry_row vx_entry_error"><div class="vx_error"><i class="fa fa-warning"></i> <?php _e('This is a required field','gravity-forms-zendesk-crm') ?></div></div>');
    return false;
    }  
   })  
 }
  ...
  e.preventDefault(); 
    if(!confirm('<?php _e('Are you sure to remove ?','gravity-forms-zendesk-crm') ?>')){
     return;   
    }
...
if(type){ row.find('.vxc_field_option').hide(); }
  ...
  if(field_name_select.length){
    ...
    if(field_name == '' || crm_fields[field_name] == ''){
     alert('<?php _e('Please Select Field Name','gravity-forms-zendesk-crm') ?>');
     return;   
    }  
...
var text= div.find('.vxc_filter_text');
 ...
 div.find('.cfx_op_sel option').removeAttr('disabled'); 
  ...
  function add_note_sel(){
    jQuery('#crm_note_fields').select2({ placeholder: '<?php _e('Select Field','gravity-forms-zendesk-crm') ?>'});
} 
...
vx_select();
  ...
  vx_select();
  function vx_select(){
      $('#vx_add_fields_select').select2({ placeholder: '<?php _e('Select Field','gravity-forms-zendesk-crm') ?>'});
