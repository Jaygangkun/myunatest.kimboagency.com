...
//var_dump($crm_fields); die();
 ...
 public function fields_html($id,$object,$refresh=false){
  ...
  if(!is_array($fields)){
      $msg= empty($fields) ? __('Fields Not Found','gravity-forms-zendesk-crm') : $fields;
  $str = '<div class="field_group_'.$this->id.'"><strong>'.__('Error:', 'gravity-forms-zendesk-crm').'</strong> '.$msg.'</div>';
  ...
  */
  ...
  <tr>
  <th scope='col' class='crm_col_heading'>" . __("Pickist Field", 'gravity-forms-zendesk-crm') . "</th>
  <th scope='col' class='crm_col_heading'>" . __("Form Fields", 'gravity-forms-zendesk-crm') . "</th>
  </tr>
  </thead>
  <tbody>".$str."
  </tbody>
...
//  toggle_choices(check_box);  
  ...
  */
  ...
  <input type="checkbox" autocomplete="off" class="<?php echo $this->id ?>_map_enabled crm_map_enabled" id="vx_check_<?php echo $this->id ?>" name="crm_map_enabled" value="<?php echo $this->id ?>" /> <?php _e("Enable Zendesk Field Mapping?", 'gravity-forms-zendesk-crm'); ?>
  </label>
  
  <div id="<?php echo $this->id ?>_map_ui" style="display: none;">
  
  <label for="<?php echo $this->id ?>_map_type_live">
  <input type="radio" class="<?php echo $this->id ?>_map_type crm_map_type" id="<?php echo $this->id ?>_map_type_live" name="<?php echo $this->id ?>_map_type" value="live" /> <?php _e("Live Remote Field Mapping ", 'gravity-forms-zendesk-crm'); gform_tooltip("vx_map_live_".$this->id); ?>
  <span class="howto" style="padding-left:1.25em;"><?php _e("Field Choices will be synced from Zendesk picklist values.", 'gravity-forms-zendesk-crm'); ?></span>
  </label>
  <label for="<?php echo $this->id ?>_map_type_once">
  <input type="radio" class="<?php echo $this->id ?>_map_type crm_map_type" id="<?php echo $this->id ?>_map_type_once" name="<?php echo $this->id ?>_map_type" value="once" /> <?php _e("Only Populate Choices ", 'gravity-forms-zendesk-crm'); gform_tooltip("vx_map_once_".$this->id) ?>
  <span class="howto" style="padding-left:1.25em;"><?php _e("Field Choices will not be updated live and are editable.", 'gravity-forms-zendesk-crm'); ?></span>
  </label>
    <label for="crm_accounts_list" style="width: 100px;" class="inline"><?php _e("Choose Account", 'gravity-forms-zendesk-crm'); ?></label>
  ...
  <option value=""><?php _e("Select a Zendesk Account", 'gravity-forms-zendesk-crm'); ?></option>
  <?php
 ...
 public function object_area($id,$object){
     ...
     ?>
       <label for="crm_object_list" style="width: 100px;" class="inline"><?php _e("Choose Object", 'gravity-forms-zendesk-crm'); ?></label>
  <?php
  if(!is_array($lists)) {
  echo __("Could not load Zendesk objects.", 'gravity-forms-zendesk-crm');
  } else { ?>
