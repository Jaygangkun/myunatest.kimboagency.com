  ...
  */
   ...
   $slug=$this->get_slug();
      if ( $file == $slug ) {
          $settings_link=$this->link_to_settings();
            array_unshift( $links, '<a href="' .$settings_link. '">' . __('Settings', 'gravity-forms-zendesk-crm') . '</a>' );
        }
        return $links;
   }
  ...
  /**
    ...
    public function add_form_settings_menu( $tabs, $form_id ) {
        ...
        $tabs[] = array( 'name' => $this->id, 'label' => __("Zendesk", 'gravity-forms-zendesk-crm') , 'query' => array( 'fid' => null) );
...
$this->push($entry,$form,'add_note');
  ...
  */
  ...
  $menus[] = array("name" => $this->id, "label" => __('Zendesk','gravity-forms-zendesk-crm'), "callback" =>  array($this, "mapping_page"), "permission" => $this->id.'_read_feeds');
  ...
  */
  public  function setup(){
      ...
      RGForms::add_settings_page(array('name' => $this->id,'tab_label' => __('Zendesk','gravity-forms-zendesk-crm'),"handler"=>array($this, "settings_page")));
  ...
  */
  ...
  _e('You do not have permissions to access this page','gravity-forms-zendesk-crm');    
  return;
  }
  ...
  */
  ...
  public function set_logging_supported($plugins) {
      $slug=$this->plugin_dir_name(); 
        $plugins[$slug] = __('Zendesk','gravity-forms-zendesk-crm');
        return $plugins;
    }
  /**
...
$sel2_css=$base_url. 'css/select2.min.css';
  ...
  check_admin_referer("vx_nonce");
  if(!current_user_can($this->id.'_edit_feeds')){
  _e('You do not have permissions to edit/save feed','gravity-forms-zendesk-crm'); 
  return;
  }
  //
...
include_once(self::$path . "templates/feed-account.php");
  ...
  */
  ...
  array_push($form['fields'],array("id" => "date_created" , "label" => __("Entry Date", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "ip" , "label" => __("User IP", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "source_url" , "label" => __("Source Url", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "payment_status" , "label" => __("Payment Status", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "payment_date" , "label" => __("Payment Date", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "payment_amount" , "label" => __("Payment Amount", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "payment_method" , "label" => __("Payment Method", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "transaction_id" , "label" => __("Transaction Id", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "currency" , "label" => __("Currency", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "form_title" , "label" => __("Form Title", 'gravity-forms-zendesk-crm')));
  array_push($form['fields'],array("id" => "status" , "label" => __('Entry Status', 'gravity-forms-zendesk-crm')));
