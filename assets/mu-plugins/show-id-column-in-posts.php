...
if( current_user_can('administrator') ) {
	...
	//add_filter('manage_posts_columns', 'ssid_column'); //Commented out by T.N.
	//add_action('manage_posts_custom_column', 'ssid_value', 10, 2); //Commented out by T.N.
	...
	add_action('manage_users_columns', 'ssid_column');  //Hacked by T.N.
	add_filter('manage_users_custom_column', 'ssid_return_value', 10, 3);  //Hacked by T.N.
